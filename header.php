...
<body <?php body_class(); ?>>
    ...
    <div id="page" class="site">
        <header class="fixed w-full z-20 top-0 start-0 bg-gray-12 border-b border-gray-200 dark:border-black">
            <div class="container mx-auto">
                <nav class="flex flex-wrap items-center justify-between py-4">
                    ...
                    <svg style="width:146px;" id="Layer_1" version="1.1" viewBox="0 0 155.1 46.7" x="0" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" y="0"><style>
                .st0 { fill: #ee3129 }
                ...
                .dark .st4 { fill: #ddd; }
                    ...
                    <div class="flex items-center md:order-2">
                        <!-- Dark mode toggle -->
                        <button id="theme-toggle" type="button" class="bg-gray-200 dark:bg-gray-800 p-2.5 focus:outline-none transition duration-300 ease-in-out mr-4">
                        ...
                        <!-- Donate Button -->
                        <a href="#" class="btn btn-primary-outline btn-sm mr-4">
                            Donate
                        </a>

                        <!-- Mobile menu button -->
                        <button id="menu-toggle" type="button" class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm md:hidden">
                    ...
                    wp_nav_menu(
                        array(
                            ...
                            'container_class' => 'items-center justify-between w-full md:flex md:w-auto md:order-1 hidden',
                            'menu_class'      => 'flex flex-col p-4 md:p-0 mt-4 font-medium md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0',
